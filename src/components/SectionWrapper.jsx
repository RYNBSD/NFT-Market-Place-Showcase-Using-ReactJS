    ...
    <div className={`min-h-screen ${styles.section} 
      ...
      <div className={`flex items-center 
        ...
        `}>
          ...
          ${styles.h1Text} md:text-center text-start`}>{title}</h1>
          <p className={`
          ${reverse ? styles.blackText : styles.whiteText}
          ${styles.descriptionText} md:text-center text-start`}>{description}</p>
          {showBtn && (
            <Button 
              assetUrl={assets.expo}
              link="https://github.com/RYNBSD/NFT-Market-Place-Using-React-Native"
            />
          )}
        </div>
        <div
